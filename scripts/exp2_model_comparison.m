...
saveas(gcf, fullfile(savePath,'pxp_4models_exp2'), 'svg');
...
writetable(T,fullfile(savePath,'params_winning_model_m2_control_nosac.csv'));

% Compute difference Com - NCom for pcommon, sigmaA and sigmaV
pcommon_diff_Com_NCom_exp2=param_m2(:,1)-param_m2(:,5);
sigmaA_diff_Com_NCom_exp2=param_m2(:,3)-param_m2(:,7);
sigmaV_diff_Com_NCom_exp2=param_m2(:,4)-param_m2(:,8);
save(fullfile(savePath,"params_diff_Com_NCom_exp2"),"pcommon_diff_Com_NCom_exp2",...
...
saveas(gcf, fullfile(savePath,'params_winning_model_m2_exp2'), 'svg');