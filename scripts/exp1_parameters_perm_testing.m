...
pcommon_mean=mean(pcommon_diff_Com_NCom_exp1);
sigA_mean=mean(sigmaA_diff_Com_NCom_exp1);
sigV_mean=mean(sigmaV_diff_Com_NCom_exp1);
...
sigV=sigmaV_diff_Com_NCom_exp1(1:nperm);
